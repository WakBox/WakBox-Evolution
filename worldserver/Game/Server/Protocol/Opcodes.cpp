...
void OpcodeTable::Load()
{
    ...
    ADD_OPCODE_HANDLER(CMSG_CLIENT_LANGUAGE,                        STATUS_AUTHED,      &WorldSession::HandleClientLanguage);
    //    ADD_OPCODE_HANDLER(CMSG_SERVER_TIME_COMMAND,                    &WorldSession::HandleServerTimeCommand);

    // Messages (MSG)
    ADD_OPCODE_HANDLER(MSG_AUTH_TOKEN,                              STATUS_AUTHED,      &WorldSession::HandleAuthTokenRequest);
    ...
    ADD_OPCODE_HANDLER(SMSG_ADDITIONAL_CHARACTER_SLOTS_UPDATE,      STATUS_NEVER,       &WorldSession::HandleServerSide);
    ...
    ADD_OPCODE_HANDLER(SMSG_INTERACTIVE_ELEMENT_SPAWN,              STATUS_NEVER,       &WorldSession::HandleServerSide);
    //    ADD_OPCODE_HANDLER(SMSG_INTERACTIVE_ELEMENT_UPDATE,             &WorldSession::HandleServerSide);
    ADD_OPCODE_HANDLER(SMSG_CHAR_SELECT,                            STATUS_NEVER,       &WorldSession::HandleServerSide);
